...
describe('ActivitiesListComponent', () => {
  ...
  describe('Initial Load', () => {
    it('should load activities on init', () => {
      ...
      httpMock.expectOne(`${environment.apiUrl}/activities`).flush([]);
    });
  ...
  describe('Delete Flow', () => {
    ...
    it('should handle delete error', () => {
      const _deleteSpy = jest.spyOn(activityService, 'deleteActivity').mockReturnValue(throwError(() => ({ message: 'Error' })));
