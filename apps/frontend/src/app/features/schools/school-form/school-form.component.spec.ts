...
describe('SchoolFormComponent', () => {
    ...
    it('should render form with all required fields', () => {
        ...
        const contactPersonField = fixture.debugElement.query(By.css('input[formControlName="contactPerson"]'));
        ...
        const schedulingNotesField = fixture.debugElement.query(By.css('textarea[formControlName="schedulingNotes"]'));
    ...
    it('should show error notification on create failure', () => {
        mockSchoolService.createSchool.mockReturnValue(
