...
export class SchoolFormComponent implements OnInit {
    ...
    private loadSchool(id: number): void {
        ...
        this.schoolService.getSchoolById(id).pipe(
            finalize(() => {
            ...
            error: (error) => {
                this.notificationService.error(
                    error.detail || 'Failed to load school',
                    'Error'
                );
    ...
    protected onSubmit(): void {
        ...
        const request = {
            ...
            truckId: (formValue.truckId !== null && formValue.truckId !== '') ? Number(formValue.truckId) : undefined,
            price: (formValue.price !== null && formValue.price !== '') ? Number(formValue.price) : undefined,
            feeDescription: formValue.feeDescription || undefined,
            formula: (formValue.formula !== null && formValue.formula !== '') ? Number(formValue.formula) : undefined,
