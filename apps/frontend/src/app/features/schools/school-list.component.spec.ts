...
describe('SchoolListComponent', () => {
    ...
    it('should open confirmation dialog when deactivate button is clicked', async () => {
        ...
        const deactivateButton = fixture.debugElement.query(By.css('button[aria-label="Deactivate school"]'));
        ...
        expect(mockModalService.confirm).toHaveBeenCalledWith({
            ...
            message: 'Are you sure you want to deactivate "School A"? It will no longer be available for new student or class assignments.',
    ...
    it('should open confirmation dialog when reactivate button is clicked', async () => {
        ...
        const reactivateButton = fixture.debugElement.query(By.css('button[aria-label="Reactivate school"]'));
        ...
        expect(mockModalService.confirm).toHaveBeenCalledWith({
            ...
            message: 'Are you sure you want to reactivate "School B"? It will become available for new student or class assignments.',
    ...
    it('should show error notification when deactivate fails', async () => {
        mockSchoolService.deactivateSchool.mockReturnValue(throwError(() => ({ detail: 'Network error' })));
        mockModalService.confirm.mockResolvedValue(true);
        mockSchoolService.schools.set([mockSchools[0]]);
        fixture.detectChanges();
    ...
    it('should disable buttons when processing a request', async () => {
        ...
        expect(fixture.debugElement.query(By.css('button[aria-label="Reactivate school"]'))).toBeTruthy();
    });
});
