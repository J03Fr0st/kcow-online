...
describe('StudentFormComponent', () => {
    ...
    beforeEach(async () => {
        ...
        mockFamilyService = {
            getFamilyById: jest.fn().mockReturnValue(of({ id: 1, familyName: 'Doe Family', guardians: [], isActive: true, createdAt: '', updatedAt: '' })),
    ...
    describe('Form Rendering', () => {
        ...
        it('should render form with all required fields', () => {
            ...
            const dateOfBirthInput = fixture.debugElement.query(By.css('input[formControlName="dateOfBirth"]'));
        ...
        it('should render grade field when Class Groups tab is active', () => {
            ...
            const classGroupsTab = tabs.find(t => t.nativeElement.textContent.trim() === 'Class Groups');
