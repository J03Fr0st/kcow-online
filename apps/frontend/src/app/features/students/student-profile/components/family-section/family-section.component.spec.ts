...
describe('FamilySectionComponent', () => {
    ...
    describe('Edit Family (AC #3)', () => {
        ...
        it('should save family changes', () => {
            ...
            const saveButton = fixture.debugElement.queryAll(By.css('button')).find(b => b.nativeElement.textContent.includes('Save'));
            saveButton!.nativeElement.click();
            fixture.detectChanges();

            expect(mockFamilyService.updateFamily).toHaveBeenCalledWith(1, expect.objectContaining({
    ...
    describe('Add Guardian (AC #2)', () => {
        ...
        it('should create new guardian', () => {
            ...
            expect(mockFamilyService.addGuardian).toHaveBeenCalledWith(1, expect.objectContaining({
                firstName: 'New',
                lastName: 'Guardian',
            }));
        });
    ...
    describe('Edit Guardian (AC #3)', () => {
        ...
        it('should show edit form when guardian edit is clicked', () => {
            const editButton = fixture.debugElement.queryAll(By.css('button')).find(b => b.nativeElement.textContent.includes('Edit'));
            editButton!.nativeElement.click();
            fixture.detectChanges();
        ...
        it('should update guardian', () => {
            ...
            expect(mockFamilyService.updateGuardian).toHaveBeenCalledWith(1, 1, expect.objectContaining({
                firstName: 'Updated',
            }));
        });
    });
    ...
    describe('Display Siblings (AC #4)', () => {
        ...
        it('should navigate to sibling profile when clicked', () => {
            const siblingButton = fixture.debugElement.queryAll(By.css('button')).find(b => b.nativeElement.textContent.includes('Sarah'));
