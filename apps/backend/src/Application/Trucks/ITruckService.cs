...
public interface ITruckService
{
    ...
    Task<List<TruckDto>> GetAllAsync(CancellationToken cancellationToken = default);
    ...
    Task<TruckDto?> GetByIdAsync(int id, CancellationToken cancellationToken = default);
    ...
    Task<TruckDto> CreateAsync(CreateTruckRequest request, CancellationToken cancellationToken = default);
    ...
    Task<TruckDto?> UpdateAsync(int id, UpdateTruckRequest request, CancellationToken cancellationToken = default);
