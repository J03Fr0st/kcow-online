...
public interface IClassGroupService
{
    ...
    Task<List<ClassGroupDto>> GetAllAsync(int? schoolId = null, int? truckId = null);
    ...
    Task<ClassGroupDto> CreateAsync(CreateClassGroupRequest request);
    ...
    Task<ClassGroupDto?> UpdateAsync(int id, UpdateClassGroupRequest request);
