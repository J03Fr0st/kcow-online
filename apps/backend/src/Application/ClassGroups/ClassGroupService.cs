...
public class ClassGroupService : IClassGroupService
{
    ...
    private readonly IClassGroupQueries _queries;

    public ClassGroupService(
        IClassGroupRepository classGroupRepository,
        ISchoolRepository schoolRepository,
        ITruckRepository truckRepository,
        ILogger<ClassGroupService> logger, IClassGroupQueries queries)
    {
    ...
    /// </summary>
    public Task<List<ClassGroupDto>> GetAllAsync(int? schoolId = null, int? truckId = null, CancellationToken cancellationToken = default) =>
        _queries.ListAsync(schoolId, truckId, cancellationToken);
